...
public class DataLogger {
	...
	public void startLogging(){
		...
		Log.i("inMAPS", "Registered WifiReceiver");
		wm01.startScan();
		Log.i("inMAPS", "Started WiFi Scan");
		started = true;
	}
	...
	private void createFileObjects() {
		...
		//PRALHAD CHANGEfwInfo = new FWriter("" + routeID + "_" + from + "_" + to, "info(rev. " +  Rev.rev  + ").txt");
	}
